...
using ChushkaWebApplication.ViewModels.Users;
...
namespace ChushkaWebApplication.Controllers
{
    public class UsersController : BaseController
    {
        ...
        public IHttpResponse Register(RegisterInputModel model)
        {
            ...
            if (string.IsNullOrWhiteSpace(model.Password) || model.Password.Length < 2)
            {
                return this.BadRequestErrorWithView("Please provide password of length 2 or more.");
            }
